...
//------------------------------------------------------------------------------
    ...
    function addTriangle(radius) {
        ...
        p.y = 1 * radius;
        p.z = 20 * radius;
        vertexIndex1 = points.push({x:p.x, y:p.y, z:p.z});

        //point 2
        p.x = -2 * radius;
        p.y = -1 * radius;
        p.z = 20 * radius;
        vertexIndex2 = points.push({x:p.x, y:p.y, z:p.z});

        //point 3
        p.x = -2 * radius;
        p.y = -1 * radius;
        p.z = 20 * radius;
        vertexIndex3 = points.push({x:p.x, y:p.y, z:p.z});
        ...
        console.log('vertexIndex' + vertexIndex1 + '.x = ' + points[vertexIndex1].x);
        console.log('vertexIndex' + vertexIndex1 + '.y = ' + points[vertexIndex1].y);
        console.log('vertexIndex' + vertexIndex1 + '.z = ' + points[vertexIndex1].z);
